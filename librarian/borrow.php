		...
		<div class="margin-top">
			<div class="row">	
								<div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;LIBROS A PRESTAR</strong>
                                </div>
...
<div class="span3">
				...
				<div class="control-group"> 
					<div class="controls">
								...
								<button name="delete_student" class="btn btn-success"><i class="icon-plus-sign icon-large"></i> PRESTAR LIBRO</button>
					</div>
				</div>
				</div>
				<div class="span8">
						<div class="alert alert-success"><strong>SELECCIONAR LIBRO</strong></div>
