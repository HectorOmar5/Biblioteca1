...
<div class="modal-body">
    <form class="form-horizontal" method="post" action="advance_search.php">
				...
				<div class="controls">
				<input type="text" name="title" id="inputEmail" placeholder="TITULO" autocomplete="off">
				</div>
				</div>
					<div class="control-group">
					<label class="control-label" for="inputPassword">AUTOR</label>
					<div class="controls">
					<input type="text" name="author" id="inputPassword" placeholder="AUTOR" autocomplete="off">
					</div>
					</div>		
