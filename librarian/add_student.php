...
<?php include('navbar_books.php'); ?>
    <div class="container">
		<div class="margin-top">
			...
			<p><a href="students.php" class="btn btn-info"><i class="icon-arrow-left icon-large"></i>&nbsp;ATRAS</a></p>
	<div class="addstudent">
	<div class="details">POR FAVOR INTRUDUZCA INFORMACION DEL ESTUDIANTE</div>		
