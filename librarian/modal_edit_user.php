	...
	<form class="form-horizontal" method="post">
			...
			<div class="control-group">
				...
				<input type="text" id="inputEmail" name="firstname" autocomplete="off" value="<?php echo $row['firstname'];  ?>" required>
				</div>
			</div>
				<div class="control-group">
				...
				<input type="text" id="inputEmail" name="lastname" autocomplete="off" value="<?php echo $row['lastname']; ?>" required>
				</div>
			</div>
			<div class="control-group">
				<div class="controls">
				<button name="edit" type="submit" class="btn btn-success"><i class="icon-save icon-large"></i>&nbsp;ACTUALIZAR DATOS</button>
				</div>
			</div>
    </form>
		</div>
