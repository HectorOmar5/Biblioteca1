        ...
        <div class="margin-top">
            ...
            <div class="span2">              
                                        <ul class="nav nav-tabs nav-stacked">
                                            <li>
                                            <a href="#add_user" data-toggle="modal" ><i class="icon-plus icon-large"></i>&nbsp;<strong>AGREGAR ADMINISTRADOR</strong></a>
                                            </li>
                                        </ul>
            ...
            <div class="span10">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                                <div class="alert alert-info">
                                    ...
                                    <strong><i class="icon-user icon-large"></i>&nbsp;ADMINISTRADORES</strong>
                                </div>
                                <thead>
                                    <tr>
                                        <th>USUARIO</th>
