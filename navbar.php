	...
	<div class="navbar navbar-fixed-top navbar-inverse">
            <div class="navbar-inner">
                <div class="container">
					...
					<li class="divider-vertical"></li>
					<li class="">
					<a rel="tooltip" data-placement="bottom" title="BIBLIOTECARIO" id="login" href="librarian"><i class="icon-user icon-large"></i>&nbsp;BIBLIOTECARIO</a>
					</li>
					<li class="divider-vertical"></li>
					<li class="">
					<a rel="tooltip" data-placement="bottom" title="ESTUDIANTE" id="login" href="login.php"><i class="icon-user icon-large"></i>&nbsp;ESTUDIANTE</a>
					</li>
					<!--<li class="divider-vertical"></li>-->
